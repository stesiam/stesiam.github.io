...
```{=html}
<div><a href="https://stesiam.shinyapps.io/Dev-Wages-App/" class="btn btn-primary btn-md"><i class="bi bi-globe"></i> Εφαρμογή</a></div>
<div><a href="https://github.com/stesiam/Dev-Wages-App" class="btn btn-primary btn-md"><i class="bi bi-github"></i> Αποθετήριο</a></div>
<div><a href="https://hub.docker.com/r/stesiam/dev-wages-app" class="btn btn-primary btn-md"><i class="bi bi-box"></i> Dockerhub</a></div>
```
:::
