...
image-alt: "A stack of euro coins symbolizing developers' earnings."
...
```{=html}
<div><a href="https://stesiam.shinyapps.io/Dev-Wages-App/" class="btn btn-outline-primary btn-md"><i class="bi bi-globe"></i> Εφαρμογή</a></div>
<div><a href="https://github.com/stesiam/Dev-Wages-App" class="btn btn-outline-primary btn-md"><i class="bi bi-github"></i> Αποθετήριο</a></div>
<div><a href="https://hub.docker.com/r/stesiam/dev-wages-app" class="btn btn-outline-primary btn-md"><i class="bi bi-box"></i> Dockerhub</a></div>
```
:::
...
Η εφαρμογή `Dev Wages` είναι στη ουσία μία εφαρμογή - ταμπλό (dashboard) που προσπαθεί να απαντήσει στο ερώτημα της γήρανσης του πληθυσμού. Η γήρανση είναι δεδομένη και μία πρόκληση που όλα τα κράτη ήδη αντιμετωπίζουν ή θα κληθούν να δώσουν απαντήσεις στις επόμενες δεκαετίες. Αυτή η εφαρμογή έχει ως στόχο να αναδείξει τον ρυθμό της γήρανσης ιστορικά, αλλά να μελετήσουμε και τις προβλέψεις.
