...
Most articles on the website are built using R and its ecosystem of packages. I typically rely on packages from the tidyverse for data import, transformation, cleaning, and visualization. Recently, I have also started converting charts in my articles from [ggplot2](https://ggplot2.tidyverse.org/8) to [highcharter](https://jkunst.com/highcharter/), a visualization library that provides improved interactivity across both desktop and smaller devices. Highcharter also offers additional options for improved accessibility. 
