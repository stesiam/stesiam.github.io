...
<div class="card border-dark">
    <div class="card-body">
      <h5 class="card-title">Developers' Wages App ⚒️</h5>
      <div class="d-flex justify-content-center mb-2">
      <span class="badge rounded-pill bg-primary">Online</span>
      </div>
    ...
    <div class="sh-card-footer text-center">
     ...
     <a class="btn btn-outline-dark" href="https://hub.docker.com/r/stesiam/dev-wages-app" role="button"><i class="fa-solid fa-cube"></i></a>
    </div>
</div>
<div class="card border-dark">
    <div class="card-body">
    ...
    <div class="sh-card-footer text-center">
     ...
     <a class="btn btn-outline-dark" href="https://hub.docker.com/repository/docker/stesiam/greek-elections-app" role="button"><i class="fa-solid fa-cube"></i></a>
    </div>
</div>
<div class="card border-dark">
    <div class="card-body">
