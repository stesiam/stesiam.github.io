---
title: "EDA on Greek Parliament (Part I)"
author: "stesiam"
description: |
...
```{r}
make_parliament_plot <- function(term, custom_title, custom1, custom2){
...
```{r, warning=FALSE}
table(parliament$FullName)%>% sort(parliament$Freq, decreasing = T) %>% head(n=15) %>% kbl()
```
