...
```{=html}
<div><a href="https://github.com/stesiam/GlassAPI" class="btn btn-outline-primary btn-md"><i class="bi bi-globe"></i> Εφαρμογή</a></div>
<div><a href="https://github.com/stesiam/GlassAPI" class="btn btn-outline-primary btn-md"><i class="bi bi-github"></i> Αποθετήριο</a></div>
