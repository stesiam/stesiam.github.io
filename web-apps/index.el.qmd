...
<div class="card border-dark" id="sa1">
    ...
    <div class="sh-card-footer text-center">
     <a class="btn btn-outline-apps" href="https://stesiam.shinyapps.io/AgeingDashboard" role="button"><i class="bi bi-globe"></i></a>
     <a class="btn btn-outline-apps" href="https://github.com/stesiam/AgeingDashboard" role="button"><i class="bi bi-github"></i></a>
    </div>
</div>
<div class="card border-dark" id="sa5">
    ...
    <div class="sh-card-footer text-center">
     ...
     <a class="btn btn-outline-apps" href="https://github.com/stesiam/Dev-Wages-App" role="button"><i class="bi bi-github"></i></a>
    </div>
</div>
<div class="card border-dark" id="sa4">
    ...
    <div class="sh-card-footer text-center">
     ...
     <i class="bi bi-globe"></i></a>
     <a class="btn btn-outline-apps" href="https://github.com/stesiam/Greek-Elections-App" role="button"><i class="bi bi-github"></i></a>
    </div>
</div>
<div class="card border-dark" id="sa2">
    ...
    <div class="sh-card-footer text-center">
     ...
     <i class="bi bi-globe"></i></a>
     <a class="btn btn-outline-apps" href="https://github.com/stesiam/ShinyDistributions" role="button"><i class="bi bi-github"></i></a>
    </div>
</div>
<div class="card border-dark" id="sa3">
    ...
    <div class="sh-card-footer text-center">
     ...
     <i class="bi bi-globe"></i></a>
     <a class="btn btn-outline-apps" href="" role="button"><i class="bi bi-github"></i></a>
    </div>
</div>
</div>
```
