---
title: "Εφαρμογές"
description: "Οι εφαρμογές που έχω φτιάξει χρησιμποιοώντας το πακέτο Shiny. Οι περισσότερες φιλοξενούνται στο shinyapps.io το οποίο έχει τους περιορισμούς επισκεψιμότητας. Σύντομα, πολλές από αυτές είτε θα τρέχουν χωρίς την ανάγκη για σέρβερ μέσω του Shinylive. Τέλος, έχω πειραματιστεί λίγο και με τη δημιουργία APIs κυρίως για τη χρήση μοντέλων μηχανικής μάθησης μέσω του πακέτου plumber και του Docker."
