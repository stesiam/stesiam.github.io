...
<div class="card border-dark" id="sa2">
    <div class="card-body">
      <h5 class="card-title">Κατανομές Πιθανοτήτων (soon)</h5>
       <div class="d-flex justify-content-center mb-2">
