...
image-alt: Verified Commit Badge on GitHub
...
format: 
  html:
    ...
    code-tools: 
      source: https://github.com/stesiam/stesiam.github.io/blob/gh-pages/english-posts/2022-10-03-Verified-Commits/index.qmd
execute:
  echo: true
editor_options: 
  markdown: 
...
Stackoverflow etc. One day I saw a `Verified` badge on someones'
