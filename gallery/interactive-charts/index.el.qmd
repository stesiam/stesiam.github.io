...
subtitle_text_gr = glue( "Σύμφωνα με τη τελευταία έκθεση του ΙΕΛΚΑ, οι συνολικές πωλήσεις ανέρχονται στα € <b>11.2</b> δις.
                         Ο Σκλαβενίτης αποτελεί την κυρίαρχη αλυσίδα σούπερμαρκετ κατέχοντας πάνω από το ένα τρίτο της αγοράς." )
...
subtitle_text_gr = glue("Παρατηρούμε ότι τα πρόσφατα χρόνια
                     υπάρχει <span style = 'font-family:uc; color:red;'>3x</span><span style = 'font-family:fs; color:red;'> &#xe098; </span> των συνολικών οχημάτων.
