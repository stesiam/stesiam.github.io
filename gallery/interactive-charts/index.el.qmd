...
sm_sales = 14.8
data = data.frame(
  "Brand" = c("Σκλαβενίτης", "LIDL", "AB", "Metro", "Μασούτης", "Κρητικός","Άλλο"),
...
subtitle_text_gr = glue( "Σύμφωνα με τη τελευταία έκθεση του ΙΕΛΚΑ, οι συνολικές πωλήσεις ανέρχονται <br> στα € <b>11.2</b> δις." )
