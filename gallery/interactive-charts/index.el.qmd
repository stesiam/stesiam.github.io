...
description: "Μία συλλογή διαγραμμάτων στα οποία υπάρχει και η δυνατότητα διάδρασης του χρήστη. Αυτά αποτελούν συνήθως παραλλαγές των στατικών διαγραμμάτων που έχω κάνει σε προκλη´σεις όπως το #TidyTuesday και το #30DayMapChallenge."
