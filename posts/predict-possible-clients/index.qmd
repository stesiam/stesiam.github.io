...
#| title: "Preview Data"
#| tbl-cap: "Preview dataset (first six rows)"
...
%%| title: "Diagram about type of variables"
%%| fig-cap: Type of variables based on its values
graph TD;
...
```{r}
#| label: response_var_to_factor
#| title: "Convert response variable to factor"
...
```{r}
#| label: function_plot_qual_vars
#| title: "Function: Create single variable plots - Qualitative"
...
```{r}
#| label: how_many_na_values
#| title: "How many NAs do I have"
#| results: hide
...
#| title: "Figure : Marital Status"
#| fig-cap: "Figure : Marital Status"
...
```{r Διάγραμμα: Μήνας τελευταίας προσέγγισης}
...
```{r}
pr = pr %>% select(.pred_class, y) %>% rename(prediction = .pred_class) 
