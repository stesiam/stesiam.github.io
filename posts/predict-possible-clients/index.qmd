...
univariateQualitativeBarPlot = function(data, column){
  freq_table = data %>%
  ...
  plot =   plot = highchart() %>%
    hc_chart(type = "bar") %>%  # Change to "column" for vertical bars
    hc_title(text = "Job Frequency Distribution") %>%
...
univariateQualitativeBarPlot(bank_dataset, job)
```
...
univariateQualitativeBarPlot(bank_dataset, marital)
```
