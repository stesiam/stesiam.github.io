...
Η ανάλυση των βέλτιστων ορίων ταξινόμησης (threshold) αναδεικνύει τρία σημαντικά ευρήματα. Πρώτον, κάθε μοντέλο λειτουργεί σε διαφορετική κλίμακα πιθανοτήτων. Η Λογιστική Παλινδρόμηση χρειάζεται threshold 0.58 (πάνω από το default 0.5), το LightGBM βρίσκει την ισορροπία του στο 0.21, ενώ το XGBoost χρειάζεται να κατέβει μέχρι το 0.09 για να δώσει ικανοποιητικές προβλέψεις. Επιπλέον, το LightGBM αναδεικνύεται σαφώς ως το καλύτερο μοντέλο και στην πρακτική εφαρμογή, με F1 = 0.45 έναντι 0.37 της Λογιστικής Παλινδρόμησης και 0.24 του XGBoost. Επίσης, αξίζει να σημειωθεί ότι το συνδυαστικό μοντέλο (Stack Ensemble) είχε χαμηλότερη απόδοση από το LightGBM μοντέλο.
