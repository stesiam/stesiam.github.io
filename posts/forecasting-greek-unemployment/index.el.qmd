...
::: {.column-margin}
```{r}
acf_lv = acf(grc_unemployment)
pacf_lv = pacf(grc_unemployment)
...
```{mermaid}
flowchart LR
    A[Σύνολο δεδομένων <br> 1998-2022 <br> 293 παρατηρήσεις]

    A --> B[Train <br> 1998-2015]
    A --> C[Test <br> 2015-2022]
```
