...
Βέβαια, ο υπολογισμός του αριθμού των ανέργων είναι αρκετά σύνθετη διαδικασία για διάφορους λόγους, όπως την ύπαρξη της υποαπασχόλησης ή εποχικής εργασίας. Υπάρχουν δύο κυρίαρχες μεθοδολογίες για τον καθορισμό τους. Ο πιο εύκολος τρόπος είναι η καταγραφή τους με βάσει τον αριθμό επιδομάτων ανεργίας που δίνονται από τη ΔΥΠΑ (πρώην ΟΑΕΔ). Το πρόβλημα είναι ότι οι προϋποθέσεις για την λήψη τέτοιου επιδόματος είναι:

- Απόλυση και όχι παραίτηση από την τελευταία του απασχόληση
