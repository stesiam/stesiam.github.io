...
#| tbl-cap: "Αποτελέσματα τομών, ανά αριθμό τομών (0 πίνακας διαβάζεται καλύτερα οριζόντια, ανά αριθμό τομών)"
#| tbl-subcap: 
#| - "Αριθμός τομής (σημείου)"
#| - "Ημερομηνία τομής"
