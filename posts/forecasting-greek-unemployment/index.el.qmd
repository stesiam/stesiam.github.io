...
models <- unemployment_ts %>%
    model(
        "ARIMA (1,1,0)" = ARIMA(Value ~ pdq(1,1,0)),
        "ARIMA (0,1,1)" = ARIMA(Value ~ pdq(0,1,1)),
        "ARIMA (1,1,1)" = ARIMA(Value ~ pdq(1,1,1)),
        "ARIMA (2,1,0)" = ARIMA(Value ~ pdq(2,1,0)),
        "ARIMA (2,1,1)" = ARIMA(Value ~ pdq(2,1,1)),
        "ARIMA (0,1,2)" = ARIMA(Value ~ pdq(0,1,2)),
        "ARIMA (1,1,2)" = ARIMA(Value ~ pdq(1,1,2)),
        "ARIMA (2,1,2)" = ARIMA(Value ~ pdq(2,1,2)),
        "ARIMA (3,1,0)" = ARIMA(Value ~ pdq(3,1,0)),
        "ARIMA (3,1,1)" = ARIMA(Value ~ pdq(3,1,1)),
        "ARIMA (3,1,2)" = ARIMA(Value ~ pdq(3,1,2)),
        "ARIMA (0,1,3)" = ARIMA(Value ~ pdq(0,1,3)),
        "ARIMA (1,1,3)" = ARIMA(Value ~ pdq(1,1,3)),
        "ARIMA (2,1,3)" = ARIMA(Value ~ pdq(2,1,3)),
        "ARIMA (3,1,3)" = ARIMA(Value ~ pdq(3,1,3))
    )
...
models <- unemployment_ts %>%
    model(
        "A-N-N" = ETS(Value ~ error("A") + trend("N") + season("N")),
        "A-A-N" = ETS(Value ~ error("A") + trend("A") + season("N")),
        "A-Ad-N" = ETS(Value ~ error("A") + trend("Ad") + season("N")),
        "A-A-A" = ETS(Value ~ error("A") + trend("A") + season("A")),
        "A-A-M" = ETS(Value ~ error("A") + trend("A") + season("M")),
        "M-A-N" = ETS(Value ~ error("M") + trend("A") + season("N")),
        "M-Ad-N" = ETS(Value ~ error("M") + trend("Ad") + season("N")),
        "M-N-N" = ETS(Value ~ error("M") + trend("N") + season("N")),
        "M-Ad-M" = ETS(Value ~ error("M") + trend("Ad") + season("M")),
    )
