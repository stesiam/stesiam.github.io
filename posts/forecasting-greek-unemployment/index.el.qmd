...
summary_stationarity_results <- data.frame(
                             ...
                             "KPSS test" =c("Μη στάσιμη", "Στάσιμη", "Στάσιμη"),
                            check.names = FALSE
)
...
data.frame("Έλεγχος" = c("Zivot-Andrews", "Zivot-Andrews", "Lee-Strazicich", "Lee-Strazicich"), 
           ...
           "Στατιστική τιμή" = c(g@teststat, g1@teststat, h[[1]]$`t-stat`, h1[[1]]$`t-stat`), 
           "Κρίσιμη τιμή (5%)" = c(h[[1]][["t-stat"]], h1[[1]][["t-stat"]], -5.65 , -5.65),
           check.names = FALSE) %>% 
