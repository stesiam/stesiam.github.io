...
$$
Όπου, t είναι η στατιστική τιμή του απλού ελέγχου Dickey-Fuller, $s$ είναι η βραχυχρόνια διακύμανση:
...
highchart() %>%
    hc_chart(type = "spline", backgroundColor = "#ffffff") %>%   # spline = smooth line
    hc_title(text = "Απόδοση ανά αριθμό διαρθρωτικών τομών") %>%
    hc_subtitle(text = "Το με βάση το Μπεύζιανό πληροφοριακό κριτήριο μας δηλώνει την ύπαρξη δύο διαρθρωτικών τομών.") %>%
