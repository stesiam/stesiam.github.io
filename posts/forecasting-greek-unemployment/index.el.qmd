...
::: {.g-col-12 .g-col-md-6}
```{r}
#| label: fig-acf-hc-levels
#| fig-cap: "Διαγραμμα αυτοσυσχέτισης αρχικών παρατηρήσεων"
...
::: {.g-col-12 .g-col-md-6}
```{r}
#| label: fig-pacf-hc-levels
#| fig-cap: "Διαγραμμα μερικής αυτοσυσχέτισης αρχικών παρατηρήσεων"
