...
library(here)
w = here::here("greek-posts/2023-06-20-Studies-in-Statistics-Greek")
```
...
subtitle_text = "Oι θέσεις για όσους θέλουν να φοιτήσουν στο τμήμα <b><span style='color:#7cae00;'>Στατιστικής του ΟΠΑ</span></b> φαίνεται να είναι αρκετά περιορισμένες για τους υποψήφιους των Γενικών Λυκείων προσφέροντας λίγες παραπάνω από 100. Τα τμήματα <b><span style='color:#f8766d;'>Αιγαίου</span></b> και <b><span style='color:#00bfc4;'>Πειραιά</span></b> τουλάχιστον τα τελευταία χρόνια ταυτίζονται ως προς τους πόσους θα δεχτούν (από τη κατηγορία ΓΛ90) με το τμήμα του Πειραιά να μειώνει σημαντικά τους εισακτέους του, σε σύγκριση με το 2013. Τέλος, το νεοσυσταθέν τμήμα της <b><span style='color:#c77cff;'>Δυτικής Μακεδονίας</span></b> ανακοινώνει σημαντικά περισσότερες θέσεις και με μεγάλες αποκλίσεις από έτος σε έτος που μπορεί να οφείλεται σε μη πλήρωση αυτών από προηγούμενες χρονιές."
...
highchart() %>%
  ...
  hc_subtitle(text = "Ο αριθμός των μαθημάτων που απαιτούνται από τα δημόσια τμήματα Στατιστικής της χώρας μας. Το τμήμα Στατιστικής του Πανεπιστημίου Δυτικής Μακεδονίας είναι το πιο απαιτηρτικό από άποψη πλήθους μαθημάτων, ακολουθούμενο από το αντίστοιχο του Πανεπιστημίου Πειραιά με το παλιό πρόγραμμα σπουδών (48 και 47 μαθήματα, αντίστοιχα. Τέλος, παρατηρείται έλλειψη ευελιξίας των προγραμμάτων όλα τα τμήματα πλην του ΟΠΑ έχουν καθορίσει υποχρεωτικά μαθήματα των οποίων ο αριθμός υπερβαίνει τα επιλεγόμενα.")  %>%
...
```{r map_statistics_deps, fig.showtext=T, height = 8, dpi = 300, warning=F}
