...
Οκ, περισσότερη εμπειρία. Όμως με τι ασχολούνται; Υπάρχουν διάφορες εργασίες που εσωκλύει ο όρος Επιστήμη Δεδομένων. Ο αναλυτής δεδομένων, ο επιστήμονας δεδομένων, ο μηχανικός δεδομένων είναι μερικές από
...
```{r}
kaggle_2021_compare$Q25 <- kaggle_2021_compare$Q25 |>
  fct_recode(
    "<7500" = "$0-999",
    "<7500" = "1,000-1,999",
    "<7500" = "2,000-2,999",
    ...
    "70,000-100,000" = "70,000-79,999",
    "70,000-100,000" = "80,000-89,999",
    "70,000-100,000" = "90,000-99,999",
    ">100,000" = "100,000-124,999",
    ">100,000" = "125,000-149,999",
    ">100,000" = "150,000-199,999",
    ">100,000" = "200,000-249,999",
    ">100,000" = "250,000-299,999",
    ">100,000" = "300,000-499,999",
    ">100,000" = "$500,000-999,999",
    ">100,000" = ">$1,000,000"
  )
...
highchart() |>
  ...
  hc_subtitle(text = "Το ένα τέταρτο των Ελλήνων χρηστών ανήκουν στη ηλικιακή ομάδα των 25-29 ετών. Γενικότερα τα άτομα κάτω των 29 ετών αποτελούν το 42% των Ελλήνων χρηστών και το 56% από άλλες χώρες.") |>
  hc_xAxis(categories = unique(data$Q25)) |>
  hc_yAxis(title = list(text = "Κατανομή (%)")) |>
  hc_tooltip(shared = TRUE, valueSuffix = " %") |>
  hc_colors(c("#1f78b4", "#33a02c")) |>
  hc_plotOptions(
...
πόσο χρόνο εκανα να συμπληρώσουν 
