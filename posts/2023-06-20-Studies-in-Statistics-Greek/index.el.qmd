...
format: 
  html:
    ...
    code-tools: 
      source: https://github.com/stesiam/stesiam.github.io/blob/gh-pages/greek-posts/2023-06-20-Studies-in-Statistics-Greek/index.qmd
execute:
  echo: true
editor_options: 
  markdown: 
...
```{r Available Admission Seats, fig.showtext=T, height = 5, dpi = 300, warning=F}
