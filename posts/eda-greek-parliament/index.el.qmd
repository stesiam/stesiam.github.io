...
```{r}
results <- lapply(3:17, get_new_members)
...
Ελέγξαμε  ανά κατηγορία ή ανά περίοδο εκλογής πώς ψηφίσαμε. Αλλά κάπου εδώ κρίνω σκόπιμη την αναφορά ενός 
