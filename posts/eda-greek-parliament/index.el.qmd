...
**Πηγή φωτογραφίας:** Pixabay, 2022 από το χρήστη [Leonhard_Niederwimmer](https://pixabay.com/photos/houses-of-parliament-greece-athens-7402132/)
:::
...
::: {.column-margin}
![](images/vas_thanou1.png)
![](images/vas_thanou.png){fig-align="center"}

Η Βασιλική Θάνου είναι η πρώτη γυναίκα που έχει διατελέσει πρωθυπουργός. Ήταν υπηρεσιακή πρωθυπουργός όταν έπεσε η κυβέρνηση του ΣΥΡΙΖΑ και προκυρήχθηκαν εκλογές. Μέχρι και σήμερα αποτελεί τη μοναδική γυναίκα που έχει υπάρξει σε αυτό το αξίωμα. 
<br>
