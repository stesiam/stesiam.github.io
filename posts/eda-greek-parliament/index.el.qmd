...
Με βάση τον παραπάνω πίνακα τα συλλεγμένα δεδομένα αποτελούνται από `r ncol(parliamentGR)` μεταβλητές (στήλες), εκ των οποίων καμία δεν είναι ποσοτική και οι υπόλοιπες πέντε είναι ποιοτικές. Από αυτές τις πέντε, οι τέσσερις είναι κατηγορικές και μία διατάξιμη μεταβλητή.
...
Ενώ η όλη αποσταθεροποίηση τεκμαίρεται και από τη σύνθεση της Βουλής της 15ης περιόδου, όπου ο αριθμός των κοινοβουλευτικών ομάδων έφτασε στο υψηλότερο επίπεδο της Μεταπολίτευσης.
