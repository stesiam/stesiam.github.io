...
::: {.column-margin}
![](images/Aleka_Papariga.png){fig-alt: "H Αλέκα Παπαρήγα, γενική γραμματέας του ΚΚΕ"}
...
::: {.column-margin}
![](images/mitso.webp){fig-alt: "Ο Κωνσταντίνος Μητσοτάκης σε ασπρόμαυρη φωτογραφία"}
...
::: {.column-margin}
![](images/papandreou.webp){fig-alt: "Ο Ανδρέας Γ. Παπανδρέου σε ασπρόμαυρη φωτογραφία"}
...
::: {.column-margin}
![](images/Konstantopoulos.webp){fig-alt: "Ο Νίκος Κωνσταντόπουλος, έγχρωμη φωτογραφία"}
...
::: {.column-margin}
![](images/el_skoura.png){fig-alt="Ασπρόμαυρο σκίτσο που αποδίδει τη μορφή της Ελένης Σκούρα, πρώτης Ελληνίδας βουλευτού"}
...
::: {.column-margin}
![](images/vas_thanou.png){fig-align="center" fig-alt="Η Βασιλική Θάνου, έγχρωμη φωτογραφία"}
