...
Με βάση τον παραπάνω πίνακα, τα συλλεγμένα δεδομένα αποτελούνται από `r ncol(parliamentGR)` μεταβλητές (στήλες), οι οποίες είναι όλες ποιοτικές μεταβλητές. Από αυτές τις πέντε, οι τέσσερις είναι κατηγορικές και μία διατάξιμη μεταβλητή.
...
Αφού εισαχθούν τα δεδομένα, καλό θα ήταν να γίνει κάποια βασική τακτοποίηση αυτών ή μία εκτεταμένη μορφή αυτής, σε περίπτωση που διαπιστώσω ότι τα δεδομένα μου δεν έχουν οργανωμένη και συνεπή δομή. Θα μελετήσουμε σταδιακά την κάθε μεταβλητή, ξεκινώντας από τα ονόματα των κομμάτων (μεταβλητή `Party`). Αρχικά, ας συλλέξουμε όλα τις πιθανές τιμές, δηλαδή όλες τις κοινοβουλευτικές ομάδες στην ιστορία του κοινοβουλίου που δεν διαλύθηκαν προτού γίνουν νέες εκλογές. Παρατηρώ αρκετά προβλήματα ως προς τα ονόματα των κομμάτων καθώς είναι μπερδεμένες συντμήσεις κομμάτων με τα κανονικά ονόματα, ενώ τα τελευταία είναι αρκετών χαρακτήρων και απαιτούν ειδικό χειρισμό.
...
Σαν να μην έφτανε αυτό, παρατηρώ ότι υπάρχουν πολλαπλές καταχωρήσεις για το ίδιο κόμμα, το οποίο ενδεχομένως κατά την πάροδο των ετών έκανε ένα μικρή αλλαγή ονόματος ή ταυτότητας (Ανεξάρτητοι Έλληνες) ή ακόμα και πιο μεγάλες αλλαγές που κατά βάση αναφέρονται και είναι πρόγονοι ή απόγονοι ως επί το πλείστον του ίδιου κόμματος (Συνασπισμός -> ΣΥΡΙΖΑ ή ΠΑΣΟΚ -> Ελιά -> Δημοκρατική Συμπαράταξη -> Κίνημα Αλλαγής -> ΠΑΣΟΚ). Μιας και αυτές οι αλλαγές δεν μπορούν να κατανοηθούν εύκολα,  κρίνεται απαραίτητη η δημιουργία ενός νέου πίνακα, ώστε να ομαδοποιήσω αυτήν την πληροφορία και να τη συγχωνεύσω στο βασικό μου σύνολο δεδομένων. 
...
Έχοντας τακτοποιήσει τις πληροφορίες μου, θα ξεκινήσω την ανάλυσή μου με μία ιστορική αναδρομή στον αριθμό των κομμάτων που έχουν εκπροσωπήσει το Ελληνικό κοινοβούλιο και έχουν ολοκληρώσει τη θητεία τους ως κοινοβουλευτική ομάδα. Από τη πτώση της χούντας, τα κόμματα που εκπροσωπούνταν στο κοινοβούλιο ήταν αρκετά λίγα, και είναι τα πλέον ιστορικά, το ΚΚΕ, η Νέα Δημοκρατία και το ΠΑΣΟΚ. Έτσι η Βουλή του 1981, εκπροσωπούνταν μόλις από τρία κόμματα. 
...
Γενικότερα, μπορούμε να χωρίσουμε τη μεταπολιτευτική περίοδο σε τρία στάδια ως προς τον αριθμό των κοινοβουλευτικών ομάδων. Τη περίοδο '74 - '81 όπου ήταν μία μεταβατική περίοδος που η χώρα απαλλάχθηκε από μία δικτατορία και εκπροσωπουνταν. Η δεύτερη περίοδος είναι από το από το 1981 εώς 2009, έχουμε εκπροσώπους από 3 μέχρι 5 κοινοβουλευτικές ομάδες και μία χαρακτηριστική συνέπεια ως προς αυτό το εύρος για το σχετικό διάστημα. Η τελευταία περίοδος ξεκινάει και με τα πρώτα σημάδια της οικονομικής κρίσης χρέους στη χώρα μας. Κοινοβουλευτικά η δυσαρέσκεια στο υπάρχον πολιτικό σύστημα ή στις πολιτικές που μας έφεραν σε μία δυσμενή οικονομική θέση δηλώθηκαν και κοινοβουλτυικά μιας σε αυτή εκτοξεύτηκε ο αριθμός των εκπροσώπων στο Κοινοβουλιο. Αυτό βέβαια έχει τουλάχιστον δύο αναγνώσεις, είτε οι υπάρχουσες φωνές δεν κάλυπταν μεγάλο φάσμα των απόψεων της κοινωνίας είτε υπήρχε τεράστια απογοήτευση για τις πολιτικές αποφάσεις των μακροημερευοντων κομμάτων.
...
-   `title_text` & `subtitle_text`: Για να θέσω το δικό μου τίτλο και υπότιτλο για το κάθε διάγραμμα συνχοτήτων κάθε κόμματος
...
party_plot(
  ...
  times_elected_min = 10,
  title_text = "Βουλευτές του Κόμματος ΠΑΣΟΚ με πάνω από 10 θητείες",
  subtitle_text = "Αριθμός εκλογών ανά βουλευτή",
  party_color = "#95bb72"
)
```
...
highchart() %>%
    ...
    hc_subtitle(
        text = "Στις τελευταίες πέντε περιόδους η εκπροσώποηση των γυναικών είναι κάτω του 1/4 των εκπροσώπων",
