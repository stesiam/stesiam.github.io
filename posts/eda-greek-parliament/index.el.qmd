...
|:----------------:|:----------------------:|:------------------------------------:|
|  `Full Name`   | *qualitative* <br> (nominal) | Επώνυμο / Όνομα / Όνομα πατέρα |
|    `Party`     | *qualitative* <br> (nominal) |    Κοινοβουλευτική όμάδα - Κόμμα που εκπροσωπεί     |
| `Constituency` | *qualitative* <br> (nominal) |       Εκλογική περιφέρεια          |
|     `Term`     | *qualitative* <br> (ordinal) |                 Περίοδος θητείας                 |
