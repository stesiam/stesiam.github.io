...
highchart() %>%
  hc_chart(type = "bar") %>%
  hc_title(text = "Δομή απαιτούμενων μαθημάτων τμημάτων Στατιστικής") %>%
...
highchart() %>%
  ...
  hc_subtitle(text = "Η πλειοψηφία των προπτυχιακών φοιτητών στατιστικής είναι άνω του 7ου έτους.") %>%
  hc_xAxis(categories = undergrads_by_year$Dept) %>%
  hc_yAxis(title = list(text = "Ποσοστό φοιτητών")) %>%
  hc_plotOptions(series = list(stacking = "normal")) %>%
  hc_add_series(name = "Φοιτητές έως 6ο έτος", data = undergrads_by_year$nonPctOv6) %>%
