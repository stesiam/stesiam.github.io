...
- Εξοικονόμηση χρόνου, όταν μία νέα έκδοση παράγει σφάλματα
- Διευκολύνει τη συνεργασία με άλλους προγραμματιστές, ειδικά μέσω πλατφορμών συνεργασίας όπως το GitHub
