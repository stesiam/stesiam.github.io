...
#| fig-cap: "Time series of trends on Version Control Systems"
...
highchart() %>%
  hc_title(text = "Trends on Version Control Systems") %>%
  hc_subtitle(text = "<span style='display: inline-block; align-items: center; text-align: center;'>Compare trends of Git <img height='16' style='margin: 0px 6px;' src='https://git-scm.com/images/logos/downloads/Git-Icon-1788C.png'> and SVN <img height='16' style='margin: 0px 6px;' src='https://upload.wikimedia.org/wikipedia/commons/thumb/2/22/Apache_Subversion_logo.svg/250px-Apache_Subversion_logo.svg.png '> (Subversion) from 2004 to 2022</span>", useHTML= TRUE) %>%
  hc_caption(
    useHTML = TRUE,
