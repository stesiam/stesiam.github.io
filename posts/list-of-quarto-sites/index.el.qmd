...
Το 2022, ανακοινώθηκε το [Quarto](https://posit.co/blog/announcing-quarto-a-new-scientific-and-technical-publishing-system/) και τα δδεομένα συγγραφής και δημοσίευσης άρθρων, αναφορών, ιστοσελίδων άλλαξαν σε μεγάλο βαθμό. Αρκετοί χρήστες του Distill αποφάσισαν να κάνουν την αλλαγή και χρησιμοποιούν ήδη το Quarto για την προσωπική τους ιστοσελίδα (διαπίστωση που προκύπτει από τη σύγκριση με την λίστα σελίδων Distill). Κάποιοι ακόμα μπορεί να διστάζουν για αυτή την αλλαγή, γιατί το Quarto είναι αρκετά νέο και μπορεί να υπάρχουν σημαντικά θέματα που να μην έχουν επιλυθεί. Ένα επιπλέον εμπόδιο είναι ο χρόνος που απαιτείται για να μάθουμε να το χειριζόμαστε μιας και η [τεκμηρίωσή του](https://quarto.org/docs/guide/), αν και εκτεταμένη, μπορεί να φανεί αποθαρρυντική στον αρχάριο χρήστη. Αυτός ήταν και ο λόγος άλλωστε που πιστεύω ότι αυτή η λίστα είναι σημαντική, προκειμένου να καταστήσει το Quarto πιο προσβάσιμο στους νέους χρήστες και να ενθαρρύνει την υιοθέτηση νέων λειτουργιών από τους υφιστάμενους χρήστες.
