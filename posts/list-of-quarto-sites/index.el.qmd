...
Λίγα χρόνια νωρίτερα αποφάσισα να φτιάξω μία ιστοσελίδα προκειμένου να έχω ένα σημείο να δείχνω τα projects μου και όχι σε διάσπαρτα αποθετήρια (repositories) στο GitHub. Έτσι δοκίμασα αρκετές λύσεις που έπρεπε να υποστηρίζουν τα Rmd αρχεία (R Markdown αρχεία). Εν τέλει είχα καταλήξει να χρησιμοποιώ το `{distill}`, και ειλικρινά το λάτρεψα, καθώς η ιστοσελίδα συνδύαζε την απλότητα και στοιχεία που την έκαναν να φαίνεται αρκετά επαγγελματική. Παρά τα όποια προβλήματα υπήρχαν με το συγκεκριμένο (πολλά εκ των οποίων λύθηκαν με το Quarto), ήμουν ιδιαίτερα ικανοποιημένος. Ωστόσο, εκείνη την περίοδο ήμουν ένας αρχάριος προγραμματιστής με αρκετά περιορισμένη γνώση HTML και CSS. Αυτό σήμαινε ότι θα μπορούσα να κάνω ελάχιστες τροποποιήσεις οι οποίες θα μου έπαιρναν πάρα πολύ χρόνο. Την ίδια περίοδο ανακάλυψα μία ιστοσελίδα που απαριθμούσε [ιστοσελίδες Distill](https://distillery.rbind.io/showcase.html). Με αυτή τη λίστα είχα καταφέρει:
