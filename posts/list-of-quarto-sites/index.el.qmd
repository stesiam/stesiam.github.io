...
::: {.callout-note}
Αποφάσισα να έχω τη λίστα και σε μορφή project στην <i class="bi bi-github"></i> [αντίστοιχη σελίδα στο GitHub Repo](https://github.com/stesiam/Quarto-Websites).
:::

Τη στιγμή που επεξεργάζομαι το συγκεκριμένο κείμενο, το Quarto έχει ξεπεράσει σε δημοφιλία άλλα πακέτα δημιουργίας ιστοσελίδων (3.4χιλ. <i class="bi bi-star-fill"></i> αστέρια), όπως το [blogdown](https://github.com/rstudio/blogdown) (1.7k <i class="bi bi-star-fill"></i>) και το [distill](https://github.com/rstudio/distill) (400 <i class="bi bi-star-fill"></i>). Δεδομένης της αυξημένης δημοφιλίας του Quarto, πήρα την πρωτοβουλία να κάνω μία λίστα ιστοσελίδων που το χρησιμοποιούν. Με αυτόν τον τρόπο αναλυτές δεδομένων που είναι χρήστες άλλων μεθόδων κατασκευής ιστοσελίδων (e.g., distill, blogdown) θα έχουν την ευκαιρία να δουν τις δυνατότητες μιας σελίδας Quarto. Επιπλέον, αυτός ο κατάλογος ενδεχομένως να βοηθήσει και όσους έχουν ήδη προσθέσει το Quarto στην εργαλειοθήκη τους, καθώς θα μπορούν να αντλούν ιδέες από ένα χώρο συγκεντρωμένων σχετικών παραδειγμάτων.
...
Λίγα χρόνια νωρίτερα αποφάσισα να φτιάξω μία ιστοσελίδα προκειμένου να έχω ένα σημείο να δείχνω τα projects μου και όχι σε διάσπαρτα αποθετήρια (repositories) στο GitHub. Έτσι δοκίμασα αρκετές λύσεις που έπρεπε να υποστηρίζουν τα Rmd αρχεία (R Markdown αρχεία). Εν τέλει είχα καταλήξει να χρησιμοποιώ το `{distill}`, και ειλικρινά το λάτρεψα, καθώς η σελίδα συνδύαζε την απλότητα και στοιχεία που την έκαναν να φαίνεται αρκετά επαγγελματική. Παρά τα όποια προβλήματα υπήρχαν με αυτό το θέμα (πολλά εκ των οποίων λύθηκαν με το Quarto), ήμουν ιδιαίτερα ικανοποιημένος. Ωστόσο, εκείνη την περίοδο ήμουν ένας αρχάριος προγραμματιστής με περιορισμένη γνώση HTML και CSS. Αυτό σήμαινε ότι θα μπορούσα να κάνω ελάχιστες τροποποιήσεις οι οποίες θα μου έπαιρναν πάρα πολύ χρόνο. Την ίδια περίοδο ανακάλυψα ένα κατάλογο που απαριθμούσε [ιστοσελίδες Distill](https://distillery.rbind.io/showcase.html). Με αυτή τη λίστα είχα καταφέρει:
...
- Κατανόηση των δυνατοτήτων και των περιορισμών του `Distill`
- Κίνητρο για τη δημιουργία σελίδας, αντλώντας έμπνευση από τις σελίδες άλλων
- Εύκολη πρόσβαση σε ενδιαφέροντα χαρακτηριστικά σελίδων συνοδευόμενα από την αντίστοιχη σελίδα κώδικα

Το 2022, ανακοινώθηκε το [Quarto](https://posit.co/blog/announcing-quarto-a-new-scientific-and-technical-publishing-system/) και τα δεδομένα συγγραφής και δημοσίευσης άρθρων, αναφορών, ιστοσελίδων άλλαξαν σε μεγάλο βαθμό. Αρκετοί χρήστες του Distill αποφάσισαν να κάνουν την αλλαγή και χρησιμοποιούν ήδη το Quarto για την προσωπική τους ιστοσελίδα (με βάση τη λίστα ιστοσελίδων Distill). Κάποιοι ακόμα μπορεί να διστάζουν για αυτή την αλλαγή, γιατί το Quarto είναι αρκετά νέο και μπορεί να υπάρχουν σημαντικά θέματα που να μην έχουν επιλυθεί. Ένα ακόμα στοιχείο είναι η ώρα που απαιτείται για να μάθουμε να το χειριζόμαστε μιας και η [τεκμηρίωσή του](https://quarto.org/docs/guide/), αν και εκτεταμένη, μπορεί να φανεί αποθαρρυντική στον αρχάριο χρήστη. Αυτός ήταν και ο λόγος άλλωστε που πιστεύω ότι αυτή η λίστα είναι σημαντική, προκειμένου να καταστήσει το Quarto πιο προσβάσιμο στους νέους χρήστες και να ενθαρρύνει την υιοθέτηση νέων λειτουργιών από τους υφιστάμενους χρήστες.
...
Μία **ενδεικτική** συλλογή των ιστοσελίδων που έχουν κατασκευαστεί χρησιμοποιώντας το Quarto είναι η εξής:

|   `r fa("user") ` &nbsp; Χρήστης    | `r fa("globe") ` &nbsp;  Σύνδεσμος ιστοσελίδας   |   `r fa("code") `  &nbsp; Κώδικας   |
|:------------------:|:------------------:|:------------------:|
|  <a href="https://github.com/aeturrell" target="_blank">aeturrell</a>  |  <a href="https://www.aeturrell.com" target="_blank">aeturrell.com</a> | <a href="https://github.com/aeturrell/home" target="_blank">home</a> |
...
| <a href="https://github.com/currocam" target="_blank">currocam</a> | <a href="https://currocam.github.io/" target="_blank">currocam.github.io</a> |  <a href="https://github.com/currocam/currocam.github.io" target="_blank">currocam.github.io</a> | 
...
|  <a href="https://github.com/djnavarro" target="_blank">djnavarro</a>  | <a href="https://blog.djnavarro.net/" target="_blank">blog.djnavarro.net/</a>  |   <a href="https://github.com/djnavarro/quarto-blog" target="_blank">quarto-blog</a>  |
...
Δυστυχώς, το Quarto δεν υποστηρίζει από μόνο του τη δημιουργία ιστοσελίδων που να υποστηρίζουν διαφορετικές γλώσσες. Αυτό δημιουργεί ενδεχομένως πρόβλημα σε όσους επιθυμούν να προωθήσουν το περιεχόμενό τους και στη μητρική τους γλώσσα, η οποία μπορεί να διαφέρει από την αγγλική. Προς το παρόν η λύση που προσφέρει επίσημα το Quarto είναι μέσω των `project profiles`, αλλά η εφαρμογή του μου φαίνεται αρκετά περίπλοκη και με ελάχιστη αναφορά στη σχετική [τεκμηρίωση (documentation)](https://quarto.org/docs/projects/profiles.html) ως προς τη συγκεκριμένη χρήση. Αν σας ενδιαφέρουν οι εξελίξεις σχετικά με την υποστήριξη πολλών γλωσσών από το Quarto μπορείτε να δείτε τη [συζήτηση για το συγκεκριμένο θέμα](https://github.com/quarto-dev/quarto-cli/issues/275) στη σελίδα του project στο GitHub. Μέχρι στιγμής, επίσημα, το Quarto δεν υποστηρίζει με έναν ξεκάθαρο τρόπο πολύγλωσσες ιστοσελίδες, ηλεκτρονικά βιβλία και ούτω καθεξής.

::: {.column-margin}
![Λογότυπο του ROpenSci](ropensci.webp)

Η [ROpenSci](https://ropensci.org/) είναι μία Μη Κερδοσκοπική Οργάνωση που ιδρύθηκε το 2011. Η συγκεκριμένη οργάνωση ενθαρρύνει μία κουλτούρα συνεργασίας στην έρευνα, όπου τα δεδομένα είναι διαθέσιμα σε όλους και το λογισμικό μπορεί να επαναχρησιμοποιηθεί, ώστε η όποια έρευνα και τα αποτελέσματα αυτής να είναι αξιόπιστα, διαφανή και εύκολα επαναλήψιμα. Η ROpenSci έχει δημιουργήσει πολλά σημαντικά πακέτα για τη γλώσσα R προκειμένου να προωθήσει το όραμά της, πολλά εκ των οποίων καθοριστικά για την κοινότητα αναλυτών της R. Ενδεικτικά αναφέρονται τα πακέτα `{babelquarto}` για τη δημιουργία ιστοτόπων σε διάφορες γλώσσες με το Quarto και το πακέτο `{targets}` που βοηθάει στην οργάνωση κατά την εκτέλεση του κώδικα. Για πλήρη λίστα πακέτων που έχει δημιουργήσει - συντηρεί το ROpenSci [μπορείτε να πατήσετε εδώ](https://ropensci.org/packages/all/).
:::

Παρόλο που δεν υπάρχει επίσημη υποστήριξη από το Quarto, δημιουργήθηκε το [babelquarto](https://github.com/ropensci-review-tools/babelquarto), ένα R πακέτο το οποίο προσπαθεί να λύσει το πρόβλημα και να κάνει τη δημιουργία πολύγλωσσων σελίδων δυνατή και εύκολη. Υπάρχουν κάποιοι ιστότοποι που έχουν ήδη ενσωματώσει το `{babelquarto}` στην εργαλειοθήκη τους και πλέον έχουν σελίδες σε πολλές γλώσσες. Μία από αυτές είναι και αυτή η ιστοσελίδα που διαβάζετε αυτή τη στιγμή! Μπορείτε να βρείτε τον [κώδικά της εδώ](https://github.com/stesiam/stesiam.github.io). Ένα άλλο ωραίο παράδειγμα πολύγλωσσης σελίδας (ιαπωνικά / αγγλικά) είναι αυτή του [Joel Nitta](https://joelnitta.com/) και το αντίστοιχο [αποθετήριό](https://github.com/joelnitta/joelnitta-home) του.

Ελπίζω όλα αυτά να σας φάνηκαν ενδιαφέροντα και γιατί όχι να σας έπεισαν να φτιάξετε και εσείς τη δική σας ιστοσελίδα σε Quarto.
