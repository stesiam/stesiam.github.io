...
Δυστυχώς, το Quarto δεν υποστηρίζει από μόνο του τη δημιουργία ιστοσελίδων που να υποστηρίζουν πολλές διάφορες γλώσσες. Αυτό δημιουργεί ενδεχομένως πρόβλημα σε όσους επιθυμούν να προωθήσουν το περιεχόμενό τους και στη (συνήθως) μητρική τους γλώσσα για το η οποία διαφέρει από τη αγγλική. Υπάρχει μία εν μέρει υποστήριξη μέσω του Quarto, μέσω των profiles. Αυτή η λύσ.
